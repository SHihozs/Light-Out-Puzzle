//Kongkit   Chatchawanhirun     6213193
...
{
    private int n;
    private ArrayList<Integer> InitialState = new ArrayList<Integer>();
    ...
    public static void main(String[] args)
    {
        ...
        LightOutPuzzle main = new LightOutPuzzle();

        while(running)
        {
            main.askSizeOfSquareGrid();
            main.askInitialState();

            System.out.println("===========================[INITIAL STATES]===========================");
            main.printTable(main.getInitialState());
            main.findMinimumMove();
            running = main.askTryAgain();
        }
    }

    public ArrayList<Integer> getInitialState() { return InitialState; }
}
